...
reporter, and (later) the elevation reporter in the SSO account — computes trail
names and performs the rendezvous window search through this package. That is
